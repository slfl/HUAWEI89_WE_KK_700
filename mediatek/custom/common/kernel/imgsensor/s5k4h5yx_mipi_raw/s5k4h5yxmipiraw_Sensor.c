...
void S5K4H5YXPreviewSetting(void)
{
   ...
   S5K4H5YX_write_cmos_sensor(0x3002, 0x0D); // rx start 05h?0Dh for Reset margin extension 
   S5K4H5YX_write_cmos_sensor(0x300A, 0x0D); // cds_start 05h?0Dh for RG/TG settling margin extension 
   S5K4H5YX_write_cmos_sensor(0x3045, 0x04);// vrg_tune VRD=2.9 for VRD(pixel reset value) regulator tune 
   S5K4H5YX_write_cmos_sensor(0x300C, 0x78);// s3_width for Comparator OTA offset cancelation switch width 
   S5K4H5YX_write_cmos_sensor(0x300D, 0x80);// s4_width for  Comparator OTA offset cancelation switch width
   ...
   S5K4H5YX_write_cmos_sensor(0x305C, 0x82);//0X8F->0X82// CDS option for Pixel output settling time tuning 
   S5K4H5YX_write_cmos_sensor(0x3010, 0x0A); // pbr_width for Pixel output settling time tuning 
